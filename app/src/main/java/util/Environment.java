...
public class Environment {
    ...
    public static String OPENWEATHER_IMG_URL = "http://openweathermap.org/img/w/";

    public static final String OPENWEATHER_API_APPID = "f32f1f5e85b0f12bdaeefcf83e1fbd7d";
